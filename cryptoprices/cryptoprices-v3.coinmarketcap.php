...
foreach ($coins as $coin) {
    ...
    $usd_vs_prices['USD'.$coin] = number_format((float)str_replace(',', '', ${'USD'.$coin}), 8, '.', ',');
...
file_put_contents(__DIR__ . '/all_pricesV3.'.basename(preg_replace('/.cryptoprices-v3./i', '',__FILE__), ".php").'.json', json_encode($output, JSON_PRETTY_PRINT));
