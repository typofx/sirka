...
<body>
        ...
        <form action="listingplatform.update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-wrap gap-4 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" name="listed" id="listed" class="form-check-input" value="1" <?php echo (($row["Listed"] ?? 0) == 1) ? 'checked' : ''; ?>> <!-- changed to checkbox-->
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" name="desktop" id="desktop" class="form-check-input" value="1" <?php echo (($row["Desktop"] ?? 0) == 1) ? 'checked' : ''; ?>> <!-- changed to checkbox-->
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" name="mobile" id="mobile" class="form-check-input" value="1" <?php echo (($row["Mobile"] ?? 0) == 1) ? 'checked' : ''; ?>> <!-- changed to checkbox-->
    ...
    <script>
        // Calcula a nota de 0 a 100% com base nos x campos
        function calculateScore() {
            ...
            let fields = [
                ...
                document.getElementById("fullydilutedmkc").value,
                ...
                document.getElementById("holders").value,
                document.getElementById("tokenLogo").value,
                document.getElementById("socialmedia").value,
                document.getElementById("metamaskbutton").value
            ];
            ...
            let validFields = fields.length - unavailableCount;
            if (validFields < 1) validFields = 1;

            let score = (okayCount / validFields) * 100;


            document.getElementById("score").value = Math.ceil(score);
        }

        // Recalcula ao alterar qualquer select
