...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['logo']) && $_FILES['logo']['error'] === UPLOAD_ERR_OK) {
        ...
        $defaultImagePath = $_SERVER['DOCUMENT_ROOT'] . '/images/icolog/default.png';
    ...
    <div class="form-container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        if (file_exists($filepath)) {
                            ...
                            if (is_array($countries)) {
                                foreach ($countries as $country) {
                                    $code = $country['code'] ?? '';
                                    $name = $country['name'] ?? '';
                                    echo "<option value='" . htmlspecialchars($code, ENT_QUOTES) . "'>" . htmlspecialchars($name) . "</option>";
                                }
                            }
                        }
                        ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="user_edit"
                    value="<?php echo htmlspecialchars($userNameUser); ?>" readonly>
            </div>
    ...
    <script>
        ...
        function generateCountryLink() {
            ...
            if (hostname) {
                ...
                accessLink.innerHTML = ""; // Limpa se for inválido
            }
        }
