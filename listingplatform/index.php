...
<link rel="stylesheet" href="https://www.plata.ie/plataforma/new-listing/desktop-style-new-listing.css">
<center>
    <br>
    <br>
    ...
    <table class="listing-container">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td class="performance-bars border-bottom1px" style="' . tokenRanked($row["Rank"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["MarketCap"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["Liquidity"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["FullyDilutedMKC"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["CirculatingSupply"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["MaxSupply"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["TotalSupply"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["Price"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["Graph"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["Holders"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["TokenLogo"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["SocialMedia"]) . '">â–ˆ</td>';
            echo '<td class="performance-bars border-bottom1px" style="' . getTXTcolor($row["MetamaskButton"]) . '">â–ˆ</td>';
...
// Selecione a Ãºltima linha da tabela
var lastRow = table.querySelector('tr:last-child');

// Selecione todas as cÃ©lulas da Ãºltima linha e remova a borda inferior
